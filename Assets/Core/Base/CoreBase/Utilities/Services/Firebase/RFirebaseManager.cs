...
namespace Utilities.Service.RFirebase
{
    ...
    public class RFirebaseManager : MonoBehaviour
    {
        ...
        public static void Init(Action<bool> pOnfinished)
        {
            ...
            //         defaults.Add(GameConstant.Ads.INTER_ADS_CONFIG, GameConstant.Ads.INTER_ADS_DEFAULT);
            //         defaults.Add(GameConstant.Ads.REWARD_ADS_CONFIG, GameConstant.Ads.REWARD_ADS_DEFAULT);
            //         defaults.Add(GameConstant.Ads.IS_HAVE_INTER_ADS_CONFIG, true);
